...
import * as Plugin_2 from '/Users/hcj/Desktop/2024/yupi/code/user-center/second-time/frontend/src/.umi/plugin-access/rootContainer.ts';
...
import * as Plugin_5 from '../plugin-model/runtime';
  ...
  plugin.register({
    apply: Plugin_2,
    path: '/Users/hcj/Desktop/2024/yupi/code/user-center/second-time/frontend/src/.umi/plugin-access/rootContainer.ts',
  });
  plugin.register({
    apply: Plugin_3,
